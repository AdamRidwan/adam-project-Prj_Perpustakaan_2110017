Public Class Form_pengembalian_2110017
        ...
        End Sub
        Sub setdg()
        dg.Columns(0).HeaderText = "Kode Pinjam"
        dg.Columns(1).HeaderText = "Tanggal Pinjam"
        ...
        dg.Columns(7).HeaderText = "Lama Pinjam"
        dg.Columns(7).HeaderText = "Tanggal Harus Kembali"
        ...
        perintah.CommandText = "select * from pengembalian_2110017 order by kdkembali_2110017 desc limit 1"
            cek = perintah.ExecuteReader()
            cek.Read()
            If cek.HasRows Then
            kode = cek.Item("kdkembali_2110017")
                no = Val(Microsoft.VisualBasic.Right(kode, 3))
                no = no + 1
            kodebaru = "PGB-" + tgl + "-" + Format(no, "000")
            Else
            kodebaru = "PGB-" + tgl + "-" + "001"
            End If
            kon.Close()
        End Sub
        Private Sub tcari_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tcari.TextChanged
            dg.Columns.Clear()
        Call tampil("select kdpinjam2110017,tglpinjam2110017,nama_anggota2110017,jurusan2110017,idbuku2110017,judul_buku2110017,penerbit2110017,thn_terbit2110017,lamapinjam2110017,tglharuskembali2110017 from peminjaman2110017,buku2110017,anggota2110017 where kdpinjam2110017 like '%" & tcari.Text & "%' or judul_buku2110017 like '%" & tcari.Text & "%' or penerbit2110017 like'%" & tcari.Text & "%'")
